...
|---------|-----------|----------------|
| CS بوليصة بوسطة | تم الحفظ ينشئ البوليصة وينزل التراك وقيمة الشحن والحالة؛ تعديل العنوان والتليفون يتحدث على بوسطة | `bosta-waybill.ts`, `bosta-client.ts`, `call-sheet.tsx`, `confirmations.ts` |
