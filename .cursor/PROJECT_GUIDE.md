...
حساب الأدمن الافتراضي (`cs@tooliano.com`) و«منى عباس» مشرفان دائماً (كل الأوردرات + توزيع). الوكيلات العاديات ترين فقط النطاق الموزَّع عليهن.
داشبورد CS بثيم Black & Gold، فلاتر هرمية (زر فلتر)، محافظة/منطقة، تاريخ من–إلى، إشعارات متابعة، وتوزيع عادل/قواعد.
