      ...
      {links.map((link) => {
        ...
        return (
          <a
            ...
            className="flex h-11 w-11 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition duration-300 hover:scale-105 hover:bg-[#20bd5a] hover:shadow-[0_0_14px_rgba(37,211,102,0.4)]"
          >
            <Icon />
          </a>
        );
