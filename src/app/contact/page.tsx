    ...
    <div className="py-12">
      <div className="mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-[0.8fr_1fr] lg:px-8">
        <aside className="rounded-[2.5rem] bg-zinc-950 p-8 text-white">
          <p className="text-sm font-bold text-brand-gold">Support</p>
          <h1 className="mt-3 text-4xl font-bold">تواصل معنا</h1>
          ...
          <div className="mt-8 space-y-4 text-sm text-zinc-300">
            <p>واتساب: يتم إضافة الرقم الرسمي</p>
            <p>الهاتف: يتم إضافة رقم خدمة العملاء</p>
            <p>العنوان: يتم إضافة بيانات مؤسسة المغربي</p>
          </div>
        </aside>

        <section className="rounded-[2.5rem] bg-white p-8 shadow-sm">
          <h2 className="text-2xl font-bold text-zinc-950">أرسل رسالة</h2>
