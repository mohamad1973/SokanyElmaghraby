...
export const products: Product[] = [
  {
    id: 101,
    name: "SK-10071 فرن توليانو 3 في 1 25 لتر 3000 وات",
    ...
    description:
      "فرن توليانو 25 لتر يجمع بين التسخين السريع والتحكم العملي، مناسب للمخبوزات والوجبات اليومية مع ضمان توليانو.",
    stockStatus: "instock",
    rating: "4.8",
    featured: true,
    attributes: {
  ...
  {
    id: 102,
    name: "SK-09087 غلاية زجاج توليانو 1.7 لتر 1500 وات",
    ...
    description:
      "غلاية توليانو زجاجية بسعة 1.7 لتر وقدرة 1500 وات، مناسبة للبيت والمكتب مع قاعدة سهلة الاستخدام.",
    stockStatus: "instock",
    rating: "4.7",
    featured: true,
    attributes: {
  ...
  {
    id: 103,
    name: "SK-15061N فرشة استشوار توليانو 1200 وات بجراب",
    ...
    description:
      "فرشة استشوار توليانو 1200 وات مناسبة للتصفيف اليومي، بتصميم مريح وجراب عملي للحفظ والتنقل.",
    stockStatus: "instock",
    rating: "4.9",
    featured: true,
    attributes: {
  ...
  {
    id: 104,
    name: "SK-13089 مساحة كهربائية بالبخار توليانو 1800 وات",
    ...
    description:
      "مساحة كهربائية بالبخار من توليانو بقدرة 1800 وات، تساعد على تنظيف أسرع وأعمق مع ضمان الوكيل الحصري.",
    stockStatus: "instock",
    rating: "4.6",
    featured: true,
    attributes: {
  ...
  {
    id: 105,
    name: "SK-16081 ماكينة توليانو ديجيتال",
    ...
    description:
      "ماكينة توليانو ديجيتال للعناية الشخصية، مناسبة للاستخدام المنزلي وتأتي بضمان توليانو.",
    stockStatus: "instock",
    rating: "4.7",
    attributes: {
      النوع: "ديجيتال",
  ...
  },
  {
    ...
    description:
      "ماكينة تنظيف بقع توليانو مناسبة للسجاد والانتريه، بقدرة 1800 وات وسعة عملية للاستخدام المنزلي.",
